...
WHERE StuID='crk23';*/
  ...
  else if ($tableName == "Students")
  {
    ...
    if(strpos($outLoginN, "Successful") !== false)
    {
      ...
      $result = mysqli_query($connect, "SELECT * FROM Students WHERE StuID = '$user' and Passwords = '$pass'"); 
      $row = mysqli_fetch_array($result, MYSQLI_ASSOC);
      if($row['StuID'] == $user && $row['Passwords'] == $pass) 
      {
      ...
      else 
      {
        ...
        VALUES ('$user','empty','empty','empty','empty','$pass')";
